...
class OrderData:
    NAME = ['Алексей', 'Владимир', 'Сергей', 'Анатолий', 'Максим']
    SURNAME = ['Смирнов', 'Федоров', 'Морозов', 'Ковалев']
    ADDRESS = ['ул. Ленина, д. 12', 'пр. Мира, д. 5', 'ул. Тверская, д. 14']
    STATION = ['Киевская', 'Маяковская', 'Тверская', 'Баррикадная']
    RENTAL_PERIOD = ['сутки', 'трое суток', 'неделя']
    COLOR = ['blue', 'red', 'green']
    COMMENT = ['Пожалуйста, не опаздывайте!', 'Вход с противоположной стороны', 'Позвоните за полчаса']